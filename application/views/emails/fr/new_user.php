...
<html lang="fr">
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        <p>Une fois connecté, vous pouvez modifier votre mot de passe comme expliqué <a href="http://fr.iamkarlsaycon.com/utilisation/comment-modifier-mon-mot-de-passe.html" title="Lien vers la documentation" target="_blank">dans cet article</a>.</p>
        <?php } ?>
        <hr>
