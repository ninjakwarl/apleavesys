...
<html lang="fr">
    ...
    <body>
        ...
        <p>Une fois connecté, vous pouvez modifier votre mot de passe comme expliqué <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="Lien vers la documentation" target="_blank">dans cet article (en anglais)</a>.</p>
        <hr>
