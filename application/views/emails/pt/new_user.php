...
<html lang="pt">
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        Depois de entrar, pode alterar a password conforme explicado <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="Link to documentation" target="_blank">aqui</a>.
        <?php } ?>
        <hr>
