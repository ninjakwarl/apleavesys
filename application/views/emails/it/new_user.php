...
<html lang="it">
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        Una volta connessi, è possibile modificare la password, come spiegato <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="Link to documentation" target="_blank">qui</a>.
        <?php } ?>
        <hr>
