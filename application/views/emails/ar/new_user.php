...
<html lang="ar">
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="Link to documentation" target="_blank">حال تأمين الإتصال، يمكنك تغيير كلمة المرور، وكما مبين هنا.</a>.
        <?php } ?>
        <hr>
