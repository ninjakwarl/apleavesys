...
<html lang="pl">
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        Po połączeniu możesz zmienić hasło, wyjaśnienie <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="Link to documentation" target="_blank">tutaj</a>.
        <?php } ?>
        <hr>
