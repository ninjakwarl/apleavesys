...
<html lang="en">
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        Після входу ви маєте можливість змінити свій пароль відповідно <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="Посилання на документацыію" target="_blank">інструкції</a>.
        <?php } ?>
        <hr>
