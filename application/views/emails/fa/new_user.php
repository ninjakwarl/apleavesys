...
<html lang="fa">
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        پس از اتصال میتوانید رمزتان را تغییر دهید، طوریکه توضیح داده شده در <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="اتصال به راهنما" target="_blank">اینجا</a>.
        <?php } ?>
        <hr>
