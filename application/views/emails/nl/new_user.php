...
<html lang="nl">
  <head>
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        Nadat u bent ingelogd, kunt u het wachtwoord wijzigen (zie <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="Link to documentation" target="_blank">hier</a> voor nadere uitleg).
        <?php } ?>
        <hr>
