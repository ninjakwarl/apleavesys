...
<html lang="vi">
    ...
    <body>
        ...
        <?php if ($this->config->item('ldap_enabled') == FALSE) { ?>
        Khi bạn đã kết nối, bạn có thể thay đổi mật khẩu của mình như được giải thích <a href="http://iamkarlsaycon.com/how-to-change-my-password.html" title="Link to documentation" target="_blank">tại đây</a>.
        <?php } ?>
        <hr>
