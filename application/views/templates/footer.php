    ...
    <div class="row" id="footer">
        ...
        <div class="span4 pull-right">
              <?php switch ($language_code){
                  case 'fr' : echo '<a class="anchor" href="http://www.iamkarlsaycon.com/" target="_blank">APLeaveSys</a>'; break;
                  default : echo '<a class="anchor" href="http://www.iamkarlsaycon.com/" target="_blank">APLeaveSys</a>'; break;
              } ?>
          &nbsp;v2.0.0&nbsp;&copy;&nbsp;2020 K.Saycon,MSIT
        </div>
    </div>
    </div>
