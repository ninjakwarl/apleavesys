<img src="https://github.com/ninjakwarl/apleavesys/blob/master/assets/images/logo_simple.png" width="80" align="left" hspace="10">

APLeaveSys is a Application Leave System developed in PHP/MySQL under an AGPL v3 licence.
APLeaveSys is designed to provide simple leave and overtime request workflows for small organizations.

## Informations / getting help

* Official website : https://www.iamkarlsaycon.com/
* User group : https://groups.google.com/forum/?hl=en#!forum/devhunt

## Status

This project is stable and ready for production. An online demo is available here : https://apleavesys.davaofibre.ph/
Use karl / karl for login / password.
...
**IMPORTANT:** If you want to install APLeaveSys in production, please download it from the Release tab.
...
* Check your installation with the <code>requirements.php</code> page at the root of your installation (e.g. http://localhost/apleavesys/requirements.php).
* The default user is *karl* and password is *karl*.
...
* Join the developers chat on gitter
